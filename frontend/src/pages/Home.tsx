...
const Home = () => {
    ...
    return (
        <div className="h-[40rem] w-full bg-stone-950 flex flex-col items-center justify-center overflow-hidden rounded-md">
            ...
            <h3 className="text-xl my-1.5 md:text-2xl lg:text-3xl text-stone-200 font-light inter-var text-center">Experience the future of communication with CipherChat.</h3>
